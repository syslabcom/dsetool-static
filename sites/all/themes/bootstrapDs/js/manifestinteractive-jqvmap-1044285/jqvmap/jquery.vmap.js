...
(function ($) {
  ...
  WorldMap.prototype = {
    ...
    highlight: function (cc, path) {
      ...
      var germany_lt = 'Vokietija';

      //Lithuanian de
      var lithuanian_en = 'Lithuania';
      var lithuanian_is = 'Litháen';
      var lithuanian_pt = 'Lituânia';
      var lithuanian_no = 'Litauen';
      var lithuanian_at = 'Litauen';
      var lithuanian_ee = 'Leedu';
      var lithuanian_ro = 'Lituania';
      var lithuanian_si = 'Litva';
      var lithuanian_es = 'Lituania';
      var lithuanian_de = 'Litauen';
      var lithuanian_lt = 'Lietuva';
      ...
      if (cc=="pt"){
        ...
        if(lastSegment == 'lt'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-pt">' + portugal_lt + '</span>');
        }
      }
      ...
      if (cc=="at"){
        ...
        if(lastSegment == 'lt'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-at">' + austria_lt + '</span>');
        }
      }
      ...
      if (cc=="ee"){
        ...
        if(lastSegment == 'lt'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-ee">' + estonia_lt + '</span>');
        }
      }
      ...
      if (cc=="si"){
        ...
        if(lastSegment == 'lt'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-si">' + slovenia_lt + '</span>');
        }
      }
      ...
      if (cc=="de"){
       ...
       if (cc=="lt"){
        ...
        if(lastSegment == 'dangerous-substances'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-lt">' + lithuanian_en + '</span>');
        }

        if(lastSegment == 'is'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-lt">' + lithuanian_is + '</span>');
        }

        if(lastSegment == 'pt'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-lt">' + lithuanian_pt + '</span>');
        }

        if(lastSegment == 'no'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-lt">' + lithuanian_no + '</span>');
        }

        if(lastSegment == 'AT_de'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-lt">' + lithuanian_at + '</span>');
        }

        if(lastSegment == 'et'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-lt">' + lithuanian_ee + '</span>');
        }

        if(lastSegment == 'ro'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-lt">' + lithuanian_ro + '</span>');
        }

        if(lastSegment == 'sl'){
          jQuery('#mapImg').append('<span class="tooltip-map tooltip-lt">' + lithuanian_si + '</span>');
        }
